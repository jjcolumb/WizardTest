...
using Fasterflect;
using WizardXpandModule.Templates;
...
namespace WizardXpandModule
{
    ...
    public class WizardController : ViewController {
        ...
        {
            var controller = Frame.GetController<FocusDefaultDetailViewItemController>();
        ...
        private void WizardControl_FinishClick(object sender, CancelEventArgs e)
        {
            ...
            if (controller.SaveAndCloseAction.Active && controller.SaveAndCloseAction.Enabled)
            {
                ...
                controller1.SaveAndCloseAction.DoExecute();
            }
            else
            {
                var controller2 = Frame.GetController<CloseWindowController>();
                controller2.CloseAction.DoExecute();
            }
        ...
        private void WizardControl_CancelClick(object sender, CancelEventArgs e) {
            UpdateControllers(View);
            var controller = Frame.GetController<CloseWindowController>();
            controller.CloseAction.DoExecute();
